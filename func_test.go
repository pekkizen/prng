...
func TestFloat64_1024Singles(t *testing.T) {
	var hi, lo uint64
	rounds := 15
	const ulps = 1
	hi = 1
...
func TestFloat64BisectSingles(t *testing.T) {
...
func TestFloat64_1024Bisect(t *testing.T) {
...
func TestFloat64_1024Bisect2(t *testing.T) {
	var rounds int = 1e7
	x1 := NewXoro(1)
	x2 := NewXoro(1)
	for i := 0; i < rounds; i++ {
...
func Test_1024RBisectR(t *testing.T) {
	var rounds int = 1e7
	x1 := NewXoro(1)
	x2 := NewXoro(1)
	for i := 0; i < rounds; i++ {
...
func TestFloat64_1024RandomReal(t *testing.T) {
	var rounds int = 1e8
	listed := 0
...
func TestRandomRealBisectR(t *testing.T) {
	var rounds int = 1e6 * 2
	key := make([]uint64, 17) 
	x := NewXoro(1)
...
func TestFloat64_1024RBisectR(t *testing.T) {
	var rounds int = 1e6 * 2
	key := make([]uint64, 17) 
	x := NewXoro(1)
...
func TestRoundingMethods(t *testing.T) {
	var rounds int = 1e9
	x := NewXoro(1)
...
func TestBitsChangedFloat64_1024(t *testing.T) {
	const rounds int = 1e9
	var sum int
	x := NewXoro(1)
