...
Float64Bisect implements the random bisecting for an arbitrary length bit sequence.
...
To keep the same number value ordering in the bit sequence 
...
The algorithm isn't **"generating"** the floats.
